...
image = Image.open(r'C:\DEPI\Recommendation system\My Work\Movie recommender system.jpg')
st.image(image)
...
df1 = pickle.load(open(r'C:\DEPI\Recommendation system\My Work\movie_list.pkl', 'rb'))
tfidf_matrix = pickle.load(open(r'C:\DEPI\Recommendation system\My Work\tfidf_matrix.pkl', 'rb'))
